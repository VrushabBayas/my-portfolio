...
export default function About() {
  return (
    <PageLayout>
                ...
                <div className='space-y-6'>
                  ...
                  <div className='space-y-4 text-lg text-muted leading-relaxed'>
                    <p>
                      ...
                      with <strong className='text-accent'>7+ years</strong> of
                      expertise in building high-performance, scalable web
                      applications. Proficient in{' '}
                      <strong className='text-primary'>
                        React.js, Redux, Webpack, and JavaScript (ES6+)
                      </strong>
                      , I craft optimized and responsive user interfaces.
                    </p>
                    <p>
                      Throughout my career, I&apos;ve successfully delivered
                      enterprise projects across various domains including{' '}
                      <strong className='text-accent'>
                        Digital Advertising, Telecom, Security, and Real-time
                        Communication
                      </strong>
                      . I excel at performance profiling, debugging, and
                      implementing best practices in front-end development,
                      including migrating applications from React 15.x/16.x to
                      React 18.x.
                    </p>
                    <p>
                      Beyond coding, I&apos;m passionate about knowledge sharing
                      through my{' '}
                      <strong className='text-accent'>
                        &quot;Coding Fun&quot; YouTube channel
                      </strong>
                      and technical writing. I believe in continuous learning
                      and staying ahead of the curve with emerging technologies
                    ...
                    <div className='flex items-center gap-4'>
                      ...
                      <div>
                        ...
                        <p className='text-sm text-muted'>
                          ...
                          applications using React.js, TypeScript, and modern
                          development tools.
                        </p>
                      </div>
                    </div>
                  ...
                  <div className='bg-card/50 backdrop-blur-sm border border-border rounded-xl p-4 hover:bg-card transition-all duration-300 micro-bounce'>
                    <div className='flex items-center gap-4'>
                      ...
                      <div>
                        ...
                        <p className='text-sm text-muted'>
                          Sharing programming knowledge and web development
                          insights through &quot;Coding Fun&quot; YouTube
                          channel and technical articles.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className='flex items-center gap-4'>
                      ...
                      <div>
                        ...
                        <p className='text-sm text-muted'>
                          ...
                          and optimizing user experiences through innovative
                          solutions.
                        </p>
                      </div>
                    </div>
          ...
          <ScrollAnimation animation='fadeUp'>
            <div className='text-center mb-16'>
              ...
              <p className='text-lg text-muted max-w-2xl mx-auto'>
                Key milestones and achievements in my software engineering
                career
              </p>
            </div>
          </ScrollAnimation>
            ...
            <ScrollAnimation animation='scale' delay={400}>
              <div className='group relative'>
                ...
                <div className='relative glass rounded-3xl p-4 sm:p-6 lg:p-8 text-center group-hover:scale-105 transition-all duration-300 border border-blue-500/20'>
                  <div className='font-heading text-3xl lg:text-4xl font-bold text-blue-500 mb-2'>
                    MSC
                  </div>
                  <div className='text-lg font-semibold text-foreground mb-1'>
                    Computer Science
          ...
          <ScrollAnimation animation='fadeUp'>
            <div className='text-center mb-16'>
              ...
              <p className='text-lg text-muted max-w-3xl mx-auto'>
                7+ years of expertise in React.js development across leading
          ...
          <div className='space-y-8'>
            ...
            <ScrollAnimation animation='fadeUp' delay={100}>
              <div className='glass rounded-3xl p-8 border border-primary/20'>
                ...
                <div className='space-y-3 text-muted'>
                  <p>
                    • Developed and optimized web-based applications using
                    React.js, Redux, and Webpack
                  </p>
                  <p>
                    • Migrated features from React 16.x to React 18.x, improving
                    component performance and load times
                  </p>
                  <p>
                    • Coordinated with backend developers to ensure seamless
                    integration of APIs and UI components
                  </p>
                  <p>
                    • Conducted code reviews and mentorship, improving team
                    efficiency and code quality
                  </p>
                  <p>
                    • Implemented best practices for TDD, unit testing, and
                    integration testing
                  </p>
                </div>
              </div>
            ...
            <ScrollAnimation animation='fadeUp' delay={200}>
              <div className='glass rounded-3xl p-8 border border-accent/20'>
                ...
                <div className='space-y-3 text-muted'>
                  <p>
                    • Built single-page applications (SPA) with React.js and
                    Redux
                  </p>
                  <p>
                    • Developed reusable components, significantly reducing
                    development effort
                  </p>
                  <p>
                    • Migrated applications from React 15.x to 16.x, improving
                    UI/UX and performance
                  </p>
                  <p>
                    • Collaborated in Agile teams, participating in sprint
                    planning and stand-ups
                  </p>
                </div>
              </div>
            </ScrollAnimation>
                    ...
                    <div>
                      ...
                      <div className='flex flex-wrap gap-2'>
                        {[
                          ...
                          <span
                            key={skill}
                            className='px-3 py-1 bg-blue-500/10 text-blue-500 rounded-lg text-sm'
                          >
                            {skill}
                          </span>
                        ))}
                    ...
                    <div>
                      ...
                      <div className='flex flex-wrap gap-2'>
                        {[
                          ...
                          <span
                            key={skill}
                            className='px-3 py-1 bg-purple-500/10 text-purple-500 rounded-lg text-sm'
                          >
                            {skill}
                          </span>
                        ))}
                  ...
                  <div className='space-y-6'>
                    ...
                    <div className='bg-card/30 rounded-xl p-4'>
                      ...
                      <p className='text-accent font-medium'>
                        Annasaheb Magar College, Pune
                      </p>
                      <p className='text-sm text-muted'>
                        Apr 2016 • Percentage: 52%
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <div className='relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <ScrollAnimation animation='fadeUp'>
            <div className='text-center mb-16'>
              ...
              <p className='text-lg text-muted max-w-3xl mx-auto'>
                My passion extends beyond software development into content
          ...
          <div className='grid lg:grid-cols-2 gap-12'>
              ...
              <div className='glass rounded-3xl p-8 border border-primary/20'>
                ...
                <div className='space-y-4'>
                  <p className='text-muted'>
                    Passionate about terminal-based development workflows with a
                  ...
                  <div className='bg-card/50 rounded-xl p-4 font-mono text-sm'>
                    ...
                    <div className='text-muted mt-2'>
                      ...
                      <br />
                      • tmux with Powerlevel10k theme
                      <br />
                      • Terminal tools: yazi, lazygit, fd, zoxide, fzf
                      <br />• Git aliases and automated workflows
                    </div>
                  </div>
                </div>
              </div>
            ...
            <ScrollAnimation animation='fadeRight' delay={200}>
              <div className='glass rounded-3xl p-8 border border-accent/20'>
                ...
                <div className='space-y-4'>
                  <p className='text-muted'>
                    Currently planning exciting ventures into moto-vlogging and
                    adventure content:
                  </p>
                    ...
                    <div className='flex items-center gap-3 p-3 bg-card/30 rounded-lg'>
                      ...
                      <div>
                        <div className='font-semibold text-foreground'>
                          Moto-Vlogging Channel
                        </div>
                        <div className='text-sm text-muted'>
                          Adventure bike touring across India
                        </div>
                      </div>
                    </div>
                    <div className='flex items-center gap-3 p-3 bg-card/30 rounded-lg'>
                      ...
                      <div>
                        ...
                        <div className='text-sm text-muted'>
                          Travel reels and adventure stories
                        </div>
                      </div>
                    </div>
                    <div className='flex items-center gap-3 p-3 bg-card/30 rounded-lg'>
          ...
          <ScrollAnimation animation='fadeUp' delay={300}>
            <div className='glass rounded-3xl p-8 lg:p-12 mt-16 text-center border border-primary/10'>
              ...
              <p className='text-lg text-muted mb-8 max-w-2xl mx-auto'>
                Whether it&apos;s discussing code, sharing adventure stories, or
                exploring new project ideas, I&apos;m always excited to connect
                with fellow creators and developers.
              </p>
              <div className='flex flex-col sm:flex-row gap-4 justify-center'>
                <Link
                  href='/projects'
                  className='group relative px-8 py-4 button-glow text-white rounded-2xl font-medium overflow-hidden transition-all duration-300 micro-bounce ripple-effect'
                >
                ...
                <Link
                  href='/contact'
                  className='group px-8 py-4 bg-card/50 backdrop-blur-sm border border-border rounded-2xl font-medium text-foreground hover:bg-card transition-all duration-300 micro-bounce ripple-effect'
                >
                  Get In Touch
                </Link>
              </div>
      ...
      <section
        className='relative py-20 lg:py-32 overflow-hidden'
        aria-label='Content creation and social media'
      >
        ...
        <div className='relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <ScrollAnimation animation='fadeUp'>
            <div className='text-center mb-16'>
              ...
              <p className='text-lg text-muted max-w-3xl mx-auto'>
                Beyond coding, I love sharing knowledge through YouTube videos
            ...
            <ScrollAnimation animation='fadeUp' delay={400}>
              <div className='max-w-4xl mx-auto'>
                <div className='glass rounded-3xl p-8 lg:p-12 text-center border border-primary/10'>
                  ...
                  <p className='text-lg text-muted mb-8 max-w-2xl mx-auto'>
                    Stay updated with my latest tutorials, insights, and
                    development tips across platforms
                  </p>
                  <div className='flex flex-col sm:flex-row gap-4 justify-center'>
                    <a
                      ...
                      className='group inline-flex items-center gap-3 px-8 py-4 bg-red-500 text-white rounded-2xl font-medium hover:bg-red-600 transition-all duration-200 hover:scale-105'
                    >
                      <span className='text-xl'>🎬</span>
                    ...
                    <a
                      ...
                      target='_blank'
                      rel='noopener noreferrer'
                      className='group inline-flex items-center gap-3 px-8 py-4 bg-green-500 text-white rounded-2xl font-medium hover:bg-green-600 transition-all duration-200 hover:scale-105'
                    >
                      <span className='text-xl'>📝</span>
                      Follow on Medium
                      <svg className='w-5 h-5 group-hover:translate-x-1 transition-transform duration-200' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
