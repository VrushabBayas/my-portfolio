...
export const projects: Project[] = [
  {
    ...
    description:
      'Interactive loan calculator built with React.js featuring real-time calculations and responsive design.',
    longDescription:
      'A comprehensive loan calculator application that helps users calculate monthly payments, interest rates, and loan terms. Features include amortization schedules, comparison tools, and export functionality.',
  ...
  },
  {
    ...
    description:
      'Scalable REST API boilerplate with authentication, validation, and comprehensive documentation.',
    longDescription:
      'A production-ready Node.js REST API boilerplate featuring JWT authentication, input validation, error handling, and comprehensive API documentation.',
  ...
  },
  {
    ...
    description:
      'Comprehensive telecom dashboard with interactive charts and data visualizations for operational decisions.',
    longDescription:
      'Built a dashboard for telecom client featuring real-time data visualization, interactive charts, and analytics tools to improve operational decision-making.',
  ...
  },
  {
    ...
    description:
      'Higher-Order Component for React tables with dynamic selection capabilities and reusable logic.',
    longDescription:
      'A proof-of-concept HOC that enables column, row, and cell selection with dynamic checkbox states and reusable logic for any table implementation.',
